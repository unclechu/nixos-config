...
#! nix-shell "let d=[p.rakudo p.coreutils p.gnupg p.diffutils];s=fetchTarball{url=\"https://releases.nixos.org/nixos/22.11/nixos-22.11.1629.2f9fd351ec3/nixexprs.tar.xz\";sha256=\"0j3gx94kd56lc4b2932bfsvz3vmmnrm9ry079p4xcahmqckhkava\";};p=import s {};in p.mkShell{buildInputs=d;}"
