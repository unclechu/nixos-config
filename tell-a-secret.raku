...
#! nix-shell "let d=[p.rakudo p.coreutils p.gnupg];s=fetchTarball{url=\"https://releases.nixos.org/nixos/21.05/nixos-21.05.1408.9376bf7b342/nixexprs.tar.xz\";sha256=\"1j035vhz7y42k12n3vh27d2h8b9h13h4qbwiw0q9jyfb61hhrvnm\";};p=import s {};in p.mkShell{buildInputs=d;}"
