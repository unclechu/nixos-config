...
#! nix-shell "let d=[p.rakudo p.coreutils p.gnupg p.diffutils];s=fetchTarball{url=\"https://releases.nixos.org/nixos/23.05/nixos-23.05.4448.5550a85a087c/nixexprs.tar.xz\";sha256=\"1zhw5sgmcdqm17x8p0mwwv2axi2sj0kmfl966rimjjgikn6vva4w\";};p=import s {};in p.mkShell{buildInputs=d;}"
