...
#! nix-shell "let d=[p.rakudo p.coreutils p.gnupg];s=fetchTarball{url=\"https://releases.nixos.org/nixos/22.05/nixos-22.05.3893.040c6d8374d/nixexprs.tar.xz\";sha256=\"11va5x27j0zzk37rl1g0izx1r665smmajs2mrh76r4ckry9kkfal\";};p=import s {};in p.mkShell{buildInputs=d;}"
