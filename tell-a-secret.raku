...
#! nix-shell "let d=[p.rakudo p.coreutils p.gnupg];s=fetchTarball{url=\"https://releases.nixos.org/nixos/21.05/nixos-21.05.3021.8b0b81dab17/nixexprs.tar.xz\";sha256=\"05n361jvj1pnq49zx82brczj9scjgs4kkgnna0242grj5pxm9ldc\";};p=import s {};in p.mkShell{buildInputs=d;}"
