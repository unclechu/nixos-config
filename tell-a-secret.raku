...
#! nix-shell "let d=[p.rakudo p.coreutils p.gnupg];s=fetchTarball{url=\"https://releases.nixos.org/nixos/22.11/nixos-22.11.632.e169cf5b3b1/nixexprs.tar.xz\";sha256=\"187vx1ab3vj9xffy568w236yhb3gi8zwrhnb9km1bjwad32m5mq2\";};p=import s {};in p.mkShell{buildInputs=d;}"
