...
#! nix-shell "let d=[p.rakudo p.coreutils p.gnupg];s=fetchTarball{url=\"https://releases.nixos.org/nixos/21.05/nixos-21.05.1353.c06613c25df/nixexprs.tar.xz\";sha256=\"184hw3ax81i50ns0rkfb36d1mbqhch7pyyxh4d9zycm7rypr25pg\";};p=import s {};in p.mkShell{buildInputs=d;}"
