...
#! nix-shell "let d=[p.rakudo p.coreutils p.gnupg];s=fetchTarball{url=\"https://releases.nixos.org/nixos/21.11/nixos-21.11.335665.0f316e4d72d/nixexprs.tar.xz\";sha256=\"095yqwfm41mmzml0xjvvk4vxjjgrycywr27jw907z6d971vhj06s\";};p=import s {};in p.mkShell{buildInputs=d;}"
