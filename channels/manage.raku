...
#! nix-shell "let d=[p.rakudo p.coreutils p.curl p.cacert p.libxml2 p.nix];s=fetchTarball{url=\"https://releases.nixos.org/nixos/20.09/nixos-20.09.4132.52090c613ad/nixexprs.tar.xz\";sha256=\"1k82rmpf39hw8cppnw980ldiscmaarkkx1mm5cfzh078b3a1wfgz\";};p=import s {};in p.mkShell{buildInputs=d;}"
