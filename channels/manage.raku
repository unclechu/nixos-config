...
#! nix-shell "let d=[p.rakudo p.coreutils p.curl p.cacert p.libxml2 p.nix];s=fetchTarball{url=\"https://releases.nixos.org/nixos/21.05/nixos-21.05.961.1f91fd10406/nixexprs.tar.xz\";sha256=\"0c8lgpnh8zfd0a4qgd7x1kxvrfn7kv0wp4bdi0iakyvkl7j62314\";};p=import s {};in p.mkShell{buildInputs=d;}"
