...
#! nix-shell "let d=[p.rakudo p.coreutils p.curl p.cacert p.libxml2 p.nix];s=fetchTarball{url=\"https://releases.nixos.org/nixos/23.05/nixos-23.05.457.f0ba8235153/nixexprs.tar.xz\";sha256=\"0knn1l3r85w4176vbcrpv22zkn6vq95qxa7qryw6y7d9abq1bspz\";};p=import s {};in p.mkShell{buildInputs=d;}"
