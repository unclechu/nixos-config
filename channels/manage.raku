...
#! nix-shell "let d=[p.rakudo p.coreutils p.curl p.cacert p.libxml2 p.nix];s=fetchTarball{url=\"https://releases.nixos.org/nixos/21.05/nixos-21.05.1523.b2f87e0043a/nixexprs.tar.xz\";sha256=\"19py1c61b4sxy2x4qy6m6k75jih1qnlf0a50klrkv384fqxv02v9\";};p=import s {};in p.mkShell{buildInputs=d;}"
