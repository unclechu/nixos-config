...
#! nix-shell "let d=[p.rakudo p.coreutils p.curl p.cacert p.libxml2 p.nix];s=fetchTarball{url=\"https://releases.nixos.org/nixos/21.05/nixos-21.05.4132.24528474d2b/nixexprs.tar.xz\";sha256=\"08vqbv17hg9v8m11azy3f47hd9a39p23gapfy28cgf27fbsh0j0d\";};p=import s {};in p.mkShell{buildInputs=d;}"
