...
#! nix-shell "let d=[p.rakudo p.coreutils p.curl p.cacert p.libxml2 p.nix];s=fetchTarball{url=\"https://releases.nixos.org/nixos/22.05/nixos-22.05.1377.09c32b0bda4/nixexprs.tar.xz\";sha256=\"0gnhk63jr6jy4lfiw5x1i8sal0mclbrww5vlrpds6g726gnaazvw\";};p=import s {};in p.mkShell{buildInputs=d;}"
